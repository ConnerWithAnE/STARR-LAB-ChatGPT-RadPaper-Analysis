...
export default function adminRouter(
  ...
  */
  ...
  router.post("/:model", getAuthMiddleware(), async (req: Request, res: Response) => {
    try {
  ...
  router.post("/papers/full", getAuthMiddleware(), async (req: Request, res: Response) => {
    try {
      const data = req.body;
  ...
  router.put("/papers/full/:id", getAuthMiddleware(), async (req: Request, res: Response) => {
    try {
  ...
  router.get("/papers/full", getAuthMiddleware(), async (req: Request, res: Response) => {
    try {
  ...
  router.get("/papers/full/:id", getAuthMiddleware(), async (req: Request, res: Response) => {
    try {
      const id = parseInt(req.params.id, 10);
      if (isNaN(id)) {
  ...
  router.get("/:model", getAuthMiddleware(), async (req: Request, res: Response) => {
    try {
      const modelName = req.params.model;
  ...
  router.get("/:model/filter", getAuthMiddleware(), async (req: Request, res: Response) => {
    try {
      const modelName = req.params.model;
  ...
  router.get("/:model/:id", getAuthMiddleware(), async (req: Request, res: Response) => {
    try {
      const modelName = req.params.model;
      const id = parseInt(req.params.id, 10);
  ...
  router.put("/:model/:id", getAuthMiddleware(), async (req: Request, res: Response) => {
    try {
      const modelName = req.params.model;
      const id = parseInt(req.params.id, 10);
  ...
  router.delete("/:model/:id", getAuthMiddleware(), async (req: Request, res: Response) => {
    try {
      const modelName = req.params.model;
      const id = parseInt(req.params.id, 10);
